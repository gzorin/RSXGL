...
#define RSXGL_MAX_TRANSFORM_FEEDBACK_BUFFER_BINDINGS RSXGL_MAX_COLOR_ATTACHMENTS
#define RSXGL_MAX_UNIFORM_BUFFER_BINDINGS RSXGL_MAX_VERTEX_TEXTURE_IMAGE_UNITS
