...
#define RSXGL_MAX_TEXTURE_IMAGE_UNITS 16
#define RSXGL_MAX_VERTEX_TEXTURE_IMAGE_UNITS 4
#define RSXGL_MAX_COMBINED_TEXTURE_IMAGE_UNITS (RSXGL_MAX_VERTEX_TEXTURE_IMAGE_UNITS + RSXGL_MAX_TEXTURE_IMAGE_UNITS)
